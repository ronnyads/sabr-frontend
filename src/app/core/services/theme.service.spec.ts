...
describe('ThemeService', () => {
  ...
  it('should force light theme and disable toggle when dark mode flag is disabled', () => {
    window.localStorage.setItem('phub.ui.theme.v1', 'dark');
    ...
    expect(window.localStorage.getItem('phub.ui.theme.v1')).toBeNull();
  });
  ...
  it('should toggle between light and dark when dark mode is enabled', () => {
    ...
    expect(window.localStorage.getItem('phub.ui.theme.v1')).toBe(next);
