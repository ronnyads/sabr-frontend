...
@Component({
  selector: 'app-admin-ml-integrations-entry',
  standalone: true,
  template: ''
})
export class AdminMlIntegrationsEntry implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    ...
    void this.router.navigate([`/t/${context.tenantId}/clients/${context.clientId}/integrations/mercadolivre`], {
      replaceUrl: true
    });
  }
}
